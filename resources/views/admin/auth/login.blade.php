@extends('admin.layouts.auth', ['class' => 'bg-default'])
            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent">
                        <div class="text-center"><img src="{{ asset('admin') }}/img/logo.png"></div>
                        <h4 class="text-center mt-2 mb-2">{{ __('Admin Login') }}</h4>
                        <div class="text-muted text-center"><small>Login with your e-mail and password</small></div>
                    </div>
