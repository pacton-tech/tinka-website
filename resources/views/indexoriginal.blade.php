    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#team">Registration</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/table.png"  class="img-fluid" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Tinka App</h3>
              <h2>Now your child is able to learn practically anywhere.
                Our app are engaging, immersive, interactive and 
                most importantly fun!</h2>
              <p>
          ...
          <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4" data-aos="fade-left">
              ...
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                <div class="box">
                  <h3 style="color: #65c600;">Tinka Tutor</h3>
              ...
              <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                <div class="box">
                  <h3 style="color: #ff901c;">Students</h3>
